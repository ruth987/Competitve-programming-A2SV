...
<pre style="position: relative;"><strong>Input:</strong> players = [4,7,9], trainers = [8,2,5,8]
...
<pre style="position: relative;"><strong>Input:</strong> players = [1,1,1], trainers = [10]
